...
def _daycount_parameters(dt1, dt2, convention, **kwargs):
    ...
    dt1 = du.asdatetime(dt1)
    dt2 = du.asdatetime(dt2)
    ...
    if convention in {'30/360 US', '30E/360', '30E/360 ISDA', '30E+/360'}:
        ...
        if convention == '30/360 US':
            # US adjustments
            if eom and dt1.month == 2 and du.iseom(dt1) and dt2.month == 2 and du.iseom(dt2):
                d2 = 30
            if eom and dt1.month == 2 and du.iseom(dt1):
                d1 = 30
            if d2 == 31 and d1>=30:
                d2 = 30
            if d1 == 31:
        ...
        if yearly_frequency:
            ...
            year_days = 366 if du.leapyear(dt2) else 365
        num_days = (dt2-dt1).days
